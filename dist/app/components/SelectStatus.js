...
var selectStatus_1 = require("../actions/selectStatus");
var SelectStatus = (function (_super) {
    ...
    SelectStatus.prototype.componentDidMount = function () {
        this.props.fetchData1();
    };
    SelectStatus.prototype.render = function () {
...
var mapDispatchToProps = function (dispatch) {
    return {
        fetchData1: function () { return dispatch(selectStatus_1.statusesFetchData()); }
    };
};
exports.default = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(SelectStatus);
